...
fun main() {
    ...
    gerenciador.adicionarTarefa(Tarefa("Ir para a faculdade", "Ir para a aula de Desenvolvimento para Dispositivos Móveis", LocalDate.of(2024, 4, 26), 3))

    // Marcar uma tarefa como concluída
    gerenciador.marcarComoConcluida("Efutuar Analise de nova tela")
    gerenciador.marcarComoConcluida("Ir para o trabalho")
